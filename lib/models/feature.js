...
var Feature = /** @class */ (function (_super) {
    ...
    function Feature(data) {
        ...
        if (_this.isLevelChanger && Array.isArray(_this.properties.levels)) {
            _this.properties.levels.forEach(function (level) { return (_this.properties["__level_".concat(level)] = true); });
        }
    ...
    Object.defineProperty(Feature.prototype, "isRamp", {
        get: function () {
            return this.properties.type === poi_type_1.POI_TYPE.RAMP;
        },
        enumerable: false,
        configurable: true
    });
    ...
    Object.defineProperty(Feature.prototype, "getTitleWithLevel", {
        get: function () {
            return "".concat(this.properties.title, " - Level: ").concat(this.properties.level);
        },
        enumerable: false,
        configurable: true
    });
