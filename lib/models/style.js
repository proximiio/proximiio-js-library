...
export default class StyleModel {
    ...
    getUniversalLayers(source) {
        ...
        return [
            new FillLayer(Object.assign(Object.assign({}, base), { id: `${source}-polygon-fill`, type: 'fill', filter, layout: {
                    visibility: 'none',
                }, paint: {
                    'fill-color': '#08c',
                    'fill-opacity': 0.3,
                } })).json,
            new LineLayer(Object.assign(Object.assign({}, base), { id: `${source}-polygon-outline`, type: 'line', filter, layout: {
                    'line-join': 'bevel',
                    visibility: 'none',
                }, paint: {
                    'line-color': '#08c',
            ...
            new LineLayer(Object.assign(Object.assign({}, base), { id: `${source}-room-outline`, type: 'line', roomFilter, layout: {
                    'line-join': 'bevel',
                    visibility: 'none',
                }, paint: {
            ...
            new FillLayer(Object.assign(Object.assign({}, base), { id: `${source}-room-fill`, type: 'fill', filter: roomFilter, layout: {
                    visibility: 'none',
                }, paint: {
            ...
            // segments
            new FillLayer(Object.assign(Object.assign({}, base), { id: `${source}-segment-fill`, type: 'fill', filter: segmentFilter, layout: {
                    visibility: 'none',
                }, paint: {
                    'fill-color': '#0c8',
                    'fill-opacity': 0.3,
                } })).json,
            new LineLayer(Object.assign(Object.assign({}, base), { id: `${source}-segment-outline`, type: 'line', filter: segmentFilter, layout: {
                    'line-join': 'bevel',
                    visibility: 'none',
                }, paint: {
                    'line-color': '#0c8',
            ...
            // routables
            new FillLayer(Object.assign(Object.assign({}, base), { id: `${source}-routable-fill`, type: 'fill', filter: routableFilter, layout: {
                    visibility: 'none',
                }, paint: {
                    'fill-color': '#c80',
                    'fill-opacity': 0.3,
                } })).json,
            new LineLayer(Object.assign(Object.assign({}, base), { id: `${source}-routable-outline`, type: 'line', filter: routableFilter, layout: {
                    'line-join': 'bevel',
                    visibility: 'none',
                }, paint: {
                    'line-color': '#c80',
    ...
    setLevel(level) {
        [...this.getLayers('main'), ...this.getLayers('route')].forEach((layer) => {
            ...
            layer.filter.forEach((filter, filterIndex) => {
    ...
    setMetadata(namespace, item, value) {
