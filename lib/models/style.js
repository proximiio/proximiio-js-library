...
var StyleModel = /** @class */ (function () {
    ...
    StyleModel.prototype.getUniversalLayers = function (source) {
        ...
        return [
            new fill_layer_1.default(__assign(__assign({}, base), { id: "".concat(source, "-polygon-fill"), type: 'fill', filter: filter, layout: {
                    visibility: 'none',
                }, paint: {
                    'fill-color': '#08c',
                    'fill-opacity': 0.3,
                } })).json,
            new line_layer_1.default(__assign(__assign({}, base), { id: "".concat(source, "-polygon-outline"), type: 'line', filter: filter, layout: {
                    'line-join': 'bevel',
                    visibility: 'none',
                }, paint: {
                    'line-color': '#08c',
            ...
            new line_layer_1.default(__assign(__assign({}, base), { id: "".concat(source, "-room-outline"), type: 'line', roomFilter: roomFilter, layout: {
                    'line-join': 'bevel',
                    visibility: 'none',
                }, paint: {
            ...
            new fill_layer_1.default(__assign(__assign({}, base), { id: "".concat(source, "-room-fill"), type: 'fill', filter: roomFilter, layout: {
                    visibility: 'none',
                }, paint: {
            ...
            // segments
            new fill_layer_1.default(__assign(__assign({}, base), { id: "".concat(source, "-segment-fill"), type: 'fill', filter: segmentFilter, layout: {
                    visibility: 'none',
                }, paint: {
                    'fill-color': '#0c8',
                    'fill-opacity': 0.3,
                } })).json,
            new line_layer_1.default(__assign(__assign({}, base), { id: "".concat(source, "-segment-outline"), type: 'line', filter: segmentFilter, layout: {
                    'line-join': 'bevel',
                    visibility: 'none',
                }, paint: {
                    'line-color': '#0c8',
            ...
            // routables
            new fill_layer_1.default(__assign(__assign({}, base), { id: "".concat(source, "-routable-fill"), type: 'fill', filter: routableFilter, layout: {
                    visibility: 'none',
                }, paint: {
                    'fill-color': '#c80',
                    'fill-opacity': 0.3,
                } })).json,
            new line_layer_1.default(__assign(__assign({}, base), { id: "".concat(source, "-routable-outline"), type: 'line', filter: routableFilter, layout: {
                    'line-join': 'bevel',
                    visibility: 'none',
                }, paint: {
                    'line-color': '#c80',
    ...
    StyleModel.prototype.setLevel = function (level) {
        __spreadArray(__spreadArray([], this.getLayers('main'), true), this.getLayers('route'), true).forEach(function (layer) {
            if (!layer.filter) {
                return;
            }
    ...
    StyleModel.prototype.updateLayer = function (layer) {
        ...
        if (idx >= 0) {
            ...
            var change = (0, deep_diff_1.diff)(prev.json, layer.json);
    ...
    StyleModel.prototype.setMetadata = function (namespace, item, value) {
        this.metadata["".concat(namespace, ":").concat(item)] = value;
    ...
    StyleModel.prototype.namespaceItems = function (namespace) {
        return Object.keys(this.metadata)
            .filter(function (key) { return key.indexOf("".concat(namespace, ":")) === 0; })
