...
var Select = /** @class */ (function () {
    ...
    function Select(dataset, options, useApiSearch) {
        ...
        var selector = (options === null || options === void 0 ? void 0 : options.selector) ? "" + options.selector : '#proximiioSelect';
        this.useApiSearch = useApiSearch !== undefined ? useApiSearch : false;
        this.ac = new Autocomplete(__assign({ data: this.getData(dataset), query: {
                manipulate: function (query) {
                    _this.query = query;
                    return query;
                }
            }, selector: selector, onSelection: function (feedback) {
    ...
    Select.prototype.getPlaces = function () {
        var _this = this;
        return {
            src: function () { return __awaiter(_this, void 0, void 0, function () {
                var places, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (!this.useApiSearch) return [3 /*break*/, 2];
                            return [4 /*yield*/, places_1.default.getPlaces(10, 0, undefined, undefined, 'name', this.query)];
                        case 1:
                            _a = _b.sent();
                            return [3 /*break*/, 4];
            ...
            src: function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (!this.useApiSearch) return [3 /*break*/, 2];
                            return [4 /*yield*/, floors_1.default.getFloors(10, 0, undefined, undefined, 'name', this.query)];
                        case 1:
                            _a = _b.sent();
                            return [3 /*break*/, 4];
        ...
        return {
            src: function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, geo_1.default.getPois()];
