...
var GuidanceStepsGenerator = /** @class */ (function () {
    ...
    GuidanceStepsGenerator.prototype.getStepDirection = function (_a) {
        ...
        if (currentPoint.isLevelChanger && nextPoint.properties.level > currentPoint.properties.level) {
            return "".concat(Direction.Up, "_").concat(LevelChangerTypes[currentPoint.properties.type]);
        }
        if (currentPoint.isLevelChanger && nextPoint.properties.level < currentPoint.properties.level) {
            return "".concat(Direction.Down, "_").concat(LevelChangerTypes[currentPoint.properties.type]);
        }
        if (previousPoint.isLevelChanger && currentPoint.isLevelChanger) {
            return "".concat(Direction.Exit, "_").concat(LevelChangerTypes[currentPoint.properties.type]);
        }
