        ...
        points.forEach((p, index) => {
            ...
            if (stepsNavigation === 'landmark' || stepsNavigation === 'landmark-levelChangers') {
                if (stepsNavigation === 'landmark') {
                    ...
                    if (typeof pathPoints[`path-part-${pathPartIndex}`] === 'undefined') {
                        if (p.isPoi && p.id === ((_c = points[index + 1]) === null || _c === void 0 ? void 0 : _c.id)) {
                            return;
                        }
                        else if ((_d = points[index + 1]) === null || _d === void 0 ? void 0 : _d.isPoi) {
                            // do not add another path part if next poi is finish
                            return;
                        }
                        if (points[index + 1]) {
                            pathPoints[`path-part-${pathPartIndex}`] = [];
                            if (p.isLevelChanger && ((_e = points[index + 1]) === null || _e === void 0 ? void 0 : _e.isLevelChanger)) {
                                pathPoints[`path-part-${pathPartIndex}`].push(p, p);
                            }
                            else if (p.isLevelChanger && !((_f = points[index + 1]) === null || _f === void 0 ? void 0 : _f.isLevelChanger)) {
                                pathPoints[`path-part-${pathPartIndex}`].push(p, p);
                                pathPartIndex++;
                                if (typeof pathPoints[`path-part-${pathPartIndex}`] === 'undefined') {
                                    pathPoints[`path-part-${pathPartIndex}`] = [];
                ...
                if (this.forceFloorLevel !== null && this.forceFloorLevel !== undefined) {
                    ...
                    if (stepsNavigation === 'simple') {
                        ...
                        else if (p.isPoi && p.id === ((_g = points[index + 1]) === null || _g === void 0 ? void 0 : _g.id)) {
                            pathPartIndex++;
                        }
                    }
                    else {
                        if (p.isLevelChanger && ((_h = points[index + 1]) === null || _h === void 0 ? void 0 : _h.isLevelChanger)) {
                            pathPartIndex++;
                            if (typeof pathPoints[`path-part-${pathPartIndex}`] === 'undefined') {
                                pathPoints[`path-part-${pathPartIndex}`] = [];
                            }
                        ...
                        if (p.isLevelChanger && !((_j = points[index + 1]) === null || _j === void 0 ? void 0 : _j.isLevelChanger)) {
                            pathPoints[`path-part-${pathPartIndex}`].push(p);
                            pathPartIndex++;
                            if (typeof pathPoints[`path-part-${pathPartIndex}`] === 'undefined') {
                        ...
                        if (p.isPoi && p.id === ((_k = points[index + 1]) === null || _k === void 0 ? void 0 : _k.id)) {
                            pathPartIndex++;
                        }
                    }
                }
                ...
                if (stepsNavigation === 'full') {
                    if (typeof pathPoints[`path-part-${pathPartIndex}`] === 'undefined') {
                        ...
                        else if (p.isPoi && p.id === ((_l = points[index + 1]) === null || _l === void 0 ? void 0 : _l.id)) {
                            return;
                        }
                        if (points[index + 1]) {
                            pathPoints[`path-part-${pathPartIndex}`] = [];
                    ...
                    if (typeof pathPoints[`path-part-${pathPartIndex}`] === 'undefined') {
                        if (p.isPoi && p.id === ((_m = points[index + 1]) === null || _m === void 0 ? void 0 : _m.id)) {
                            return;
                        }
                        if (points[index + 1]) {
                            pathPoints[`path-part-${pathPartIndex}`] = [];
                            if (p.isLevelChanger && ((_o = points[index + 1]) === null || _o === void 0 ? void 0 : _o.isLevelChanger)) {
                                pathPoints[`path-part-${pathPartIndex}`].push(p, p);
                            }
                            else if (p.isLevelChanger && !((_p = points[index + 1]) === null || _p === void 0 ? void 0 : _p.isLevelChanger)) {
                                pathPoints[`path-part-${pathPartIndex}`].push(p, p);
                                pathPartIndex++;
                                if (typeof pathPoints[`path-part-${pathPartIndex}`] === 'undefined') {
                                    pathPoints[`path-part-${pathPartIndex}`] = [];
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (const [index, val] of route.legs[0].steps.entries()) {
                    paths[`path-part-${index}`] = new Feature(lineString(val.geometry.coordinates, { level: start.properties.level, source: 'cityRoute', step: index }));
                }
                const levelPaths = {};
