    ...
    Routing.prototype.route = function (start, finish) {
        ...
        for (var _i = 0, _a = Object.entries(pathPoints); _i < _a.length; _i++) {
            ...
            if (pointsList.length > 1) {
                console.log('forceFloorleevle', this.forceFloorLevel);
                paths[key] =
                    this.forceFloorLevel !== null && this.forceFloorLevel !== undefined
                        // @ts-ignore
                        ? new feature_1.default((0, helpers_1.lineString)(pointsList.map(function (i) { return i.geometry.coordinates; })))
                        // @ts-ignore
                        : new feature_1.default(helpers_1.lineString(pointsList.map(function (i) { return i.geometry.coordinates; })));
            }
            else {
                paths[key] =
                    this.forceFloorLevel !== null && this.forceFloorLevel !== undefined
                        // @ts-ignore
                        ? new feature_1.default((0, helpers_1.point)(pointsList.map(function (i) { return i.geometry.coordinates; })))
                        // @ts-ignore
                        : new feature_1.default(helpers_1.point(pointsList.map(function (i) { return i.geometry.coordinates; })));
            }
            paths[key].id = key;
            // @ts-ignore
