...
var PaintProperties = /** @class */ (function (_super) {
    ...
    function PaintProperties(data) {
        ...
        _this.backgroundColor = data['background-color'] || '#000000';
        _this.backgroundPattern = data['background-pattern'];
        _this.backgroundOpacity = data['background-opacity'] || 1;
        return _this;
    }
