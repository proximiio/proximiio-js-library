...
var PaintProperties = /** @class */ (function (_super) {
    ...
    function PaintProperties(data) {
        ...
        _this.rasterOpacity = data['raster-opacity'] || 1;
        _this.rasterHueRotate = data['raster-hue-rotate'] || 0;
        _this.rasterBrightnessMin = data['raster-brightness-min'] || 0;
        _this.rasterBrightnessMax = data['raster-brightness-max'] || 1;
        _this.rasterSaturation = data['raster-saturation'] || 0;
        _this.rasterContrast = data['raster-contrast'] || 0;
        _this.rasterResampling = data['raster-resampling'] || 'linear';
        _this.rasterFadeDuration = data['raster-fade-duration'] || 300;
        return _this;
    }
...
var RasterLayer = /** @class */ (function (_super) {
    __extends(RasterLayer, _super);
    function RasterLayer(data) {
