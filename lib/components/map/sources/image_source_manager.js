...
var ImageSourceManager = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, floors_1.getFloors()];
                    case 1:
                        _a.floors = _b.sent();
                        return [2 /*return*/];
                }
    ...
    ImageSourceManager.prototype.setLevel = function (map, level) {
        var _this = this;
        ...
        if (this.enabled) {
            ...
            floors.forEach(function (floor) {
                ...
                var sourceId = "image-source-" + floor.id;
                ...
                map.addLayer(layer, _this.belowLayer);
