...
var guidanceStepsGenerator_1 = require("../guidanceStepsGenerator");
var RoutingSource = /** @class */ (function (_super) {
    ...
    RoutingSource.prototype.setConfig = function (config) {
        this.routing.setConfig(config);
    };
    RoutingSource.prototype.update = function (start, finish) {
        return __awaiter(this, void 0, void 0, function () {
            var route, paths, guidanceStepsGenerator, lines, _i, _a, _b, k, v;
            return __generator(this, function (_c) {
                ...
                if (start && finish) {
                    ...
                    guidanceStepsGenerator = new guidanceStepsGenerator_1.default(route === null || route === void 0 ? void 0 : route.points);
