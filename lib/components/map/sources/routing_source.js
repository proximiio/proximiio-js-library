        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (start && finish) {
                ...
                if (this.navigationType === 'city') {
                    ...
                    if (startAtMall) {
                        const entranceId = (_a = start.properties.metadata) === null || _a === void 0 ? void 0 : _a.entrance;
                        const entranceFeature = (_b = this.pois) === null || _b === void 0 ? void 0 : _b.find((f) => f.id === entranceId || f.properties.id === entranceId);
                        ...
                        const entranceId = (_c = finish.properties.metadata) === null || _c === void 0 ? void 0 : _c.entrance;
                        const entranceFeature = (_d = this.pois) === null || _d === void 0 ? void 0 : _d.find((f) => f.id === entranceId || f.properties.id === entranceId);
                ...
                if (this.navigationType === 'mall') {
                    ...
                    if (guidanceStepsGenerator.steps) {
                        this.steps = guidanceStepsGenerator.steps
                            ...
                            .map((i) => (Object.assign(Object.assign({}, i), { navMode: 'mall' })));
                    }
                }
                if (this.navigationType === 'city') {
                    this.steps = [];
                ...
                if (this.navigationType === 'combined') {
                    ...
                    if (!(mallRoute === null || mallRoute === void 0 ? void 0 : mallRoute.paths) || !(cityRoute === null || cityRoute === void 0 ? void 0 : cityRoute.paths)) {
                        this.lines = [];
