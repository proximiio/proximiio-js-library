...
var guidanceTextGenerator_1 = require("../guidanceTextGenerator");
var RoutingSource = /** @class */ (function (_super) {
    ...
    RoutingSource.prototype.update = function (start, finish) {
        return __awaiter(this, void 0, void 0, function () {
            var route, paths, guidanceTextGenerator, lines, _i, _a, _b, k, v;
            return __generator(this, function (_c) {
                ...
                if (start && finish) {
                    ...
                    guidanceTextGenerator = new guidanceTextGenerator_1.default(route === null || route === void 0 ? void 0 : route.points);
