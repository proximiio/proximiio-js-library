...
var Map = /** @class */ (function () {
    ...
    Map.prototype.centerOnRoute = function (_a) {
        var route = _a.route, wholeFloor = _a.wholeFloor;
    ...
    Map.prototype.focusOnRoute = function (floor) {
        var routePoints = floor
    ...
    Map.prototype.animate = function () {
        ...
        if (this.arc && (this.arc[this.counter] || this.arc[this.counter - 1])) {
            var point = turf.point(this.arc[this.counter] ? this.arc[this.counter] : this.arc[this.counter - 1]);
            var start = this.arc[this.counter >= this.steps ? this.counter - 1 : this.counter];
            var end = this.arc[this.counter >= this.steps ? this.counter : this.counter + 1];
