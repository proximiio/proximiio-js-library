    ...
    fetch() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (places && features && floors && style && kiosks) {
                ...
                this.state = Object.assign(Object.assign({}, this.state), { initializing: false, place, places: places.data, floor, floors: floors.data, allFloors: floors.data, kiosks: kiosks.data, style,
                    styles,
                    amenities,
                    features,
                    ...
                    if (t >= 1) {
                        ...
                        if (this.defaultOptions.autoLevelChange && this.routingSource.navigationType === 'mall') {
                            if (this.routingSource.route && Object.keys(this.routingSource.route).length - 1 === this.currentStep) {
                                if (((_a = this.routingSource.stops) === null || _a === void 0 ? void 0 : _a.length) !== this.currentStop) {
                                    this.setStop('next');
                                }
                                return;
                            }
