...
export class Map {
    constructor(options) {
        ...
        this.onMapReadyListener = new Subject();
        this.onPlaceSelectListener = new Subject();
        this.onFloorSelectListener = new Subject();
        this.onRouteFoundListener = new Subject();
        this.onRouteFailedListener = new Subject();
        this.onRouteCancelListener = new Subject();
        this.onFeatureAddListener = new Subject();
        this.onFeatureUpdateListener = new Subject();
        this.onFeatureDeleteListener = new Subject();
        this.onPolygonClickListener = new Subject();
        this.onPoiClickListener = new Subject();
        this.onPersonUpdateListener = new Subject();
        this.onStepSetListener = new Subject();
        this.defaultOptions = {
