...
var Map = /** @class */ (function () {
    ...
    Map.prototype.getUpcomingFloorNumber = function (way) {
        ...
        if (this.routingSource.lines && this.routingSource.route) {
            ...
            var nextRouteIndex = this.routingSource.lines.findIndex(function (route) { return +route.properties.level === (way === 'up' ? currentRoute_1.properties.level + 1 : currentRoute_1.properties.level - 1); });
