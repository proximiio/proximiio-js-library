...
var Map = /** @class */ (function () {
    ...
    Map.prototype.setActivePolygons = function (amenityId) {
        var _this = this;
        if (this.defaultOptions.initPolygons) {
            var activeFeatures = this.activePolygonsAmenity ? this.state.allFeatures.features.filter(function (f) { var _a; return f.properties.amenity === _this.activePolygonsAmenity && ((_a = f.properties.metadata) === null || _a === void 0 ? void 0 : _a.polygon_id) && f.geometry.type === 'Point'; }) : [];
            var amenityFeatures = amenityId ? this.state.allFeatures.features.filter(function (f) { var _a; return f.properties.amenity === amenityId && ((_a = f.properties.metadata) === null || _a === void 0 ? void 0 : _a.polygon_id) && f.geometry.type === 'Point'; }) : [];
