...
export class Map {
    ...
    fetch() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const amenities = yield getAmenities({
    ...
    initRasterTiles() {
        ...
        if (this.map) {
            ...
            this.state.style.addSource('raster-tiles', {
                ...
                attribution: ((_e = this.defaultOptions.rasterTilesOptions) === null || _e === void 0 ? void 0 : _e.attribution)
                    ...
                    : metadata['proximiio:raster:attribution']
                        ? metadata['proximiio:raster:attribution']
                        : '',
                bounds: ((_f = this.defaultOptions.rasterTilesOptions) === null || _f === void 0 ? void 0 : _f.bounds)
            ...
            this.state.style.addLayer({
                ...
                type: 'raster',
                source: 'raster-tiles',
                minzoom: ((_g = this.defaultOptions.rasterTilesOptions) === null || _g === void 0 ? void 0 : _g.minZoom)
                    ? this.defaultOptions.rasterTilesOptions.minZoom
                    : metadata['proximiio:raster:minzoom']
                        ? metadata['proximiio:raster:minzoom']
                        : 15,
                maxzoom: ((_h = this.defaultOptions.rasterTilesOptions) === null || _h === void 0 ? void 0 : _h.maxZoom)
    ...
    handlePolygonSelection(poi) {
        ...
        features.forEach((feat) => {
            ...
            if (connectedPolygonId) {
                const selectedPolygon = this.state.allFeatures.features.find((i) => {
                    var _a, _b;
    ...
    updateImages() {
        return __awaiter(this, void 0, void 0, function* () {
            yield Promise.all(this.state.amenities.map((amenity) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (amenity.icon) {
                    try {
                        const response = yield this.map.loadImage(amenity.icon);
                        if (response) {
