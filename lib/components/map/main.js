...
import { PolygonsLayer, PolygonIconsLayer, PolygonTitlesLayer, ParkingPolygonTitlesLayer, ParkingPolygonsLayer, } from './custom-layers';
...
export class Map {
    ...
    fetch() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { places, style, styles, features, amenities, floors } = yield Repository.getPackage({
        ...
        if (connectedPolygonId) {
            this.selectedPolygon = this.state.allFeatures.features.find((i) => {
                ...
                return ((_a = i.properties._dynamic) === null || _a === void 0 ? void 0 : _a.id) === connectedPolygonId &&
                    (((_b = i.properties._dynamic) === null || _b === void 0 ? void 0 : _b.type) === 'shop-custom' || ((_c = i.properties._dynamic) === null || _c === void 0 ? void 0 : _c.type) === 'parking_spot-custom');
            });
            if (this.selectedPolygon) {
                this.map.setFeatureState({
                    source: 'main',
                ...
                for (const f of activeFeatures) {
                    const polygon = this.state.allFeatures.features.find((i) => {
                        ...
                        return ((_a = i.properties._dynamic) === null || _a === void 0 ? void 0 : _a.id) === ((_b = f.properties._dynamic) === null || _b === void 0 ? void 0 : _b.polygon_id) &&
                            (((_c = i.properties._dynamic) === null || _c === void 0 ? void 0 : _c.type) === 'shop-custom' || ((_d = i.properties._dynamic) === null || _d === void 0 ? void 0 : _d.type) === 'parking_spot-custom');
                    });
                    if (polygon) {
                        this.map.setFeatureState({
                            source: 'main',
