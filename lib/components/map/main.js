...
var Map = /** @class */ (function () {
    function Map(options) {
        ...
        this.map = new mapboxgl.Map(__assign(__assign({}, this.defaultOptions.mapboxOptions), { container: this.defaultOptions.selector }));
        this.initialize();
    }
    ...
    Map.prototype.fetch = function () {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var _c, places, style, styles, features, amenities, defaultPlace, place, center;
            var _this = this;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0: return [4 /*yield*/, repository_1.default.getPackage()];
                    case 1:
                        _c = _d.sent(), places = _c.places, style = _c.style, styles = _c.styles, features = _c.features, amenities = _c.amenities;
                        ...
                        center = ((_a = this.defaultOptions.mapboxOptions) === null || _a === void 0 ? void 0 : _a.center) ? this.defaultOptions.mapboxOptions.center : [place.location.lng, place.location.lat];
                        style.center = center;
                        ...
                        this.state = __assign(__assign({}, this.state), { initializing: false, place: place, places: places, style: style, styles: styles, amenities: amenities, features: features, allFeatures: new feature_1.FeatureCollection(features), latitude: center[1], longitude: center[0], zoom: (_b = this.defaultOptions.mapboxOptions) === null || _b === void 0 ? void 0 : _b.zoom, noPlaces: places.length === 0 });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (!this.defaultOptions.zoomIntoPlace) return [3 /*break*/, 3];
