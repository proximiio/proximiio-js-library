...
var Map = /** @class */ (function () {
    ...
    Map.prototype.onMapReady = function (e) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var map, routingLayer, usePrefixed, shopsLayer, routingSymbolsLayer, decodedChevron, decodedPersonIcon, decodedFloorchangeUpImage, decodedFloorchangeDownImage, decodedPopupImage;
            var _this = this;
        ...
        if (this.map) {
            ...
            this.map.on('click', 'proximiio-levelchangers', function (ev) {
                ...
                if (_this.routingSource.points) {
                    ...
                    if (((_a = directionIcon === null || directionIcon === void 0 ? void 0 : directionIcon.properties) === null || _a === void 0 ? void 0 : _a.destinationLevel) &&
        ...
        var levelChangers = this.state.textNavigation.steps
            ...
            return new feature_1.default({
                ...
                properties: {
                    ...
                    popupImage: 'popup',
                    description: i18n_1.translations[_this.defaultOptions.language][levelChangerType] + " \n " + i18n_1.translations[_this.defaultOptions.language][direction] + " " + i18n_1.translations[_this.defaultOptions.language]['TO_FLOOR'] + " " + (destinationFloor.name ? destinationFloor.name : levelChanger.destinationLevel),
    ...
    Map.prototype.initUrlParams = function () {
        ...
        var defaultPlace = placeParam
            ? this.state.places.find(function (p) { return p.id === placeParam || p.name === placeParam; })
            : this.state.place;
    ...
    Map.prototype.onSetAmenityFilter = function (amenityId, category, inverted) {
        ...
        this.filterOutFeatures();
        if (!inverted && !Array.isArray(amenityId))
    ...
    Map.prototype.setActivePolygons = function (amenityId) {
        ...
        if (this.defaultOptions.initPolygons) {
            ...
            var amenityFeatures = amenityId
                ? this.state.allFeatures.features.filter(function (f) { var _a; return f.properties.amenity === amenityId && ((_a = f.properties._dynamic) === null || _a === void 0 ? void 0 : _a.polygon_id) && f.geometry.type === 'Point'; })
                : [];
