...
export class Map {
  ...
  `;
    ...
    onSetCustomPosition({ coordinates, level, bearing, recenter = true, iconSize = 1.5, directionIconSize = 1.25, followBearing = false, followRouteBearing = false, addPositionIcon = true, floorChangeRule = 'always', }) {
        var _a, _b, _c;
    ...
    animateCustomPosition({ from, to, level, userBearing, followRouteBearing, }) {
        ...
        // handle snapping
        if (((_a = this.routingSource) === null || _a === void 0 ? void 0 : _a.lines) && this.defaultOptions.customPositionOptions.snapDistanceLimit > 0) {
            ...
            if (distanceToSnappedPoint < this.defaultOptions.customPositionOptions.snapDistanceLimit) {
                to = snappedPoint.geometry.coordinates;
            }
        }
    ...
    setCustomPosition({ coordinates, level, bearing, recenter = true, iconSize, directionIconSize, followBearing = false, followRouteBearing = false, addPositionIcon = true, floorChangeRule = 'always', }) {
