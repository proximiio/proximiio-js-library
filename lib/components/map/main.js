...
export class Map {
    ...
    onSetFeaturesHighlight(features, color, radius, blur, enlargeIcon) {
        const map = this.map;
        ...
        if (this.routingSource &&
            ...
            if (this.defaultOptions.routeAnimation.type === 'point' || this.defaultOptions.routeAnimation.type === 'puck') {
                ...
                const animate = (currentTime) => {
                    ...
                    pointData.features[0] = point(this.defaultOptions.routeAnimation.useLerp
                        ? [
     ...
     *  });
     */
    setFeaturesHighlight(features, color, radius, blur, enlargeIcon) {
