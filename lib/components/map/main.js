        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (places && features && floors && style && kiosks) {
                ...
                this.state = Object.assign(Object.assign({}, this.state), { initializing: false, place, places: places.data, floor, floors: floors.data, kiosks: kiosks.data, style,
                    styles,
                    amenities,
                    features, allFeatures: new FeatureCollection(features), levelChangers: new FeatureCollection({ features: levelChangers }), latitude: centerVar[1], longitude: centerVar[0], zoom: this.defaultOptions.zoomLevel ? this.defaultOptions.zoomLevel : (_c = this.defaultOptions.mapboxOptions) === null || _c === void 0 ? void 0 : _c.zoom, noPlaces: places.data.length === 0 });
