        ...
        if (this.defaultOptions.initPolygons) {
            ...
            if (activeFeatures.length > 0) {
                var _loop_4 = function (f) {
                    var polygon = this_4.state.allFeatures.features.find(function (i) { var _a, _b, _c; return ((_a = i.properties._dynamic) === null || _a === void 0 ? void 0 : _a.id) === ((_b = f.properties._dynamic) === null || _b === void 0 ? void 0 : _b.polygon_id) && ((_c = i.properties._dynamic) === null || _c === void 0 ? void 0 : _c.type) === 'shop-custom'; });
                    if (polygon) {
            ...
            if (amenityFeatures.length > 0) {
                var _loop_5 = function (f) {
                    var polygon = this_5.state.allFeatures.features.find(function (i) { var _a, _b, _c; return ((_a = i.properties._dynamic) === null || _a === void 0 ? void 0 : _a.id) === ((_b = f.properties._dynamic) === null || _b === void 0 ? void 0 : _b.polygon_id) && ((_c = i.properties._dynamic) === null || _c === void 0 ? void 0 : _c.type) === 'shop-custom'; });
                    if (polygon) {
