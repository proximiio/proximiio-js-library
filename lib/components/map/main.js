        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        if (!!isTemporary) return [3 /*break*/, 4];
                        featureIndex = this.state.allFeatures.features.findIndex(function (x) { return x.id === feature.id || x.properties.id === feature.id; });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        featureIndex = this.state.allFeatures.features.findIndex(function (x) { return x.id === id || x.properties.id === id; });
