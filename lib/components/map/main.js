...
export class Map {
    constructor(options) {
        ...
        this.fullStepsNavigation = false;
  ...
  `;
    ...
    fetch() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (features) {
                ...
                const levelChangers = features.modifiedFeatures.features.filter((f) => f.properties.type === 'elevator' || f.properties.type === 'escalator' || f.properties.type === 'staircase');
                ...
                this.routingSource.setFloors(this.defaultOptions.defaultPlaceId
    ...
    onMapReady(e) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const map = e.target;
            if (map) {
                (_a = this.state.style) === null || _a === void 0 ? void 0 : _a.togglePaths(this.defaultOptions.showPaths);
                // routing layers
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.map) {
                ...
                if (features) {
                    ...
                    const levelChangers = features.modifiedFeatures.features.filter((f) => f.properties.type === 'elevator' || f.properties.type === 'escalator' || f.properties.type === 'staircase');
                    this.state = Object.assign(Object.assign({}, this.state), { features: features.modifiedFeatures, optimizedFeatures, allFeatures: new FeatureCollection(features.modifiedFeatures), levelChangers: new FeatureCollection({ features: levelChangers }) });
    ...
    onSetKiosk({ lat, lng, level, parkingKiosk = false, useAsRouteStart = true, }) {
        if (this.map && this.defaultOptions.isKiosk) {
            ...
            if (this.defaultOptions.routeAnimation.type === 'puck') {
                const startPointCircle = circle(kioskPoint.geometry.coordinates, this.defaultOptions.routeAnimation.puckRadius ? this.defaultOptions.routeAnimation.puckRadius : 0.002);
                const startPointCircleHalo = circle(kioskPoint.geometry.coordinates, this.defaultOptions.routeAnimation.puckRadius ? this.defaultOptions.routeAnimation.puckRadius + 0.001 : 0.003);
    ...
    initGeoLocation() {
        if (this.map && this.defaultOptions.useGpsLocation) {
            ...
            geolocate.on('error', (e) => __awaiter(this, void 0, void 0, function* () {
                console.log('geolocation error', e);
                if (!navigator.permissions)
                    return;
                try {
                    const permission = yield navigator.permissions.query({ name: 'geolocation' });
                    permission.onchange = () => {
    ...
    onDeleteFeature(id, isTemporary = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!isTemporary) {
                ...
                const optimizedFeatureIndex = this.state.optimizedFeatures.features.findIndex((x) => x.id === id || x.properties.id === id);
                if (featureIndex)
                    this.state.features.features.splice(featureIndex, 1);
                if (optimizedFeatureIndex)
                    this.state.optimizedFeatures.features.splice(optimizedFeatureIndex, 1);
        ...
        if (this.routingSource &&
            ...
            if (this.defaultOptions.routeAnimation.type === 'point' || this.defaultOptions.routeAnimation.type === 'puck') {
                ...
                const animate = (currentTime) => {
                    ...
                    const lineAlong = lineSplit(route.properties.source === 'cityRoute' || this.fullStepsNavigation ? routeUntilNextStep : route, currentPoint).features[0];
    ...
    onSetCustomPosition({ coordinates, level, recenter = true, iconSize = 1.5, directionIconSize = 1.25, followRouteBearing = false, addPositionIcon = true, floorChangeRule = 'always', }) {
        var _a, _b, _c, _d;
        // handle snapping
        if (this.defaultOptions.customPositionOptions.snapDistanceLimit > 0 &&
            ...
            let routeLine;
            if ((_a = this.routingSource) === null || _a === void 0 ? void 0 : _a.lines) {
                ...
                const paths = this.state.allFeatures.features.filter((path) => path.properties.class === 'path' && path.properties.level === level);
        ...
        if (isCurrentVisibleFloor || isDebouncedFloor) {
            ...
            const from = (_b = this.customPosition) === null || _b === void 0 ? void 0 : _b.coordinates;
            ...
            if (from) {
                if (this.defaultOptions.customPositionOptions.minDistanceToChange === 0 ||
                    ...
                    if (this.state.style.sources['custom-position-point']) {
                        ...
                        this.onUpdateFeature({
                            ...
                            lat: coordinates[1],
                            lng: coordinates[0],
                            floorId: floor === null || floor === void 0 ? void 0 : floor.id,
                        });
                    }
                }
            }
            ...
            if (this.defaultOptions.customPositionOptions.minDistanceToChange === 0 ||
                ...
                if (this.routingSource && this.routingSource.route) {
                    ...
                    if ((_d = (_c = this.routingSource.finish) === null || _c === void 0 ? void 0 : _c.geometry) === null || _d === void 0 ? void 0 : _d.coordinates) {
    ...
    onSetCustomPositionHeading({ heading, followBearing = false }) {
    ...
    animateCustomPosition({ from, to, level, followRouteBearing, }) {
        ...
        if (!this.defaultOptions.customPositionOptions.enableAnimation) {
            ...
            if (source) {
                ...
                if (!followRouteBearing)
                    sourceFeature.properties.bearing = this.customPositionHeading;
            }
            return;
        }
     ...
     *  });
     */
    addCustomFeature(titleOrOptions, level, lat, lng, icon, id, placeId, floorId, properties, isTemporary) {
        return __awaiter(this, void 0, void 0, function* () {
            let opts;
            ...
            return yield this.onAddNewFeature(opts);
        });
    }
    /**
     ...
     *  });
     */
    updateFeature(idOrOptions, title, level, lat, lng, icon, placeId, floorId, properties, isTemporary) {
        return __awaiter(this, void 0, void 0, function* () {
            let opts;
            // ✅ Detect which version is used
     ...
     *  });
     */
    setKiosk(latOrOptions, lng, level, parkingKiosk = false, useAsRouteStart = true) {
        let opts;
        // ✅ Detect which version is used
    ...
    setCustomPosition({ coordinates, level, recenter = true, iconSize, directionIconSize, followRouteBearing = false, addPositionIcon = true, floorChangeRule = 'always', }) {
        var _a;
        ...
        if (this.positionsList.length >= this.defaultOptions.customPositionOptions.aggregatePositionsLimit ||
            (((_a = this.routingSource) === null || _a === void 0 ? void 0 : _a.lines) && this.defaultOptions.customPositionOptions.disableAggregationWhileRouting)) {
     ...
     *  });
     */
    setCustomPositionHeading({ heading, followBearing = false }) {
