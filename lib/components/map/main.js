...
// @ts-ignore
var TBTNav = require("../../../lib/assets/tbtnav");
                ...
                switch (_e.label) {
                    ...
                    case 2:
                        ...
                        if (this.defaultOptions.enableTBTNavigation) {
                            this.routeFactory = new TBTNav.RouteFactory(JSON.stringify(this.state.allFeatures.features), this.defaultOptions.language ? this.defaultOptions.language : 'en');
                        }
                        return [2 /*return*/];
                }
            });
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, common_1.getImageFromBase64(icons_1.popupImage)];
                    case 5:
        ...
        if (this.map && this.defaultOptions.useGpsLocation) {
            ...
            if (this.defaultOptions.geolocationControlOptions.autoLocate === false) {
                setTimeout(function () {
                    ...
                    // @ts-ignore
                    geolocate_1._geolocateButton.classList.add('mapboxgl-ctrl-geolocate-background');
                    // @ts-ignore
                    geolocate_1._geolocateButton.classList.remove('mapboxgl-ctrl-geolocate-active');
                    // @ts-ignore
...
>>>>>>> feature/multiple-steps-per-floor
                    }
                }
            });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, geo_1.addFeatures({
                                type: 'FeatureCollection',
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, geo_1.deleteFeatures({
                                type: 'FeatureCollection',
...
=======
                var routePoints = this.routingSource.route["path-part-" + this.currentStep] &&
                    ...
                    : helpers_1.lineString(this.routingSource.levelPoints[floor.level].map(function (i) { return i.geometry.coordinates; }));
>>>>>>> feature/multiple-steps-per-floor
...
=======
                var routePoints = this.routingSource.route["path-part-" + this.currentStep] &&
                    ...
                    ? this.routingSource.route["path-part-" + this.currentStep]
                    : helpers_1.lineString(this.routingSource.levelPoints[this.state.floor.level].map(function (i) { return i.geometry.coordinates; }));
>>>>>>> feature/multiple-steps-per-floor
                var lengthInMeters = turf.length(routePoints, { units: 'kilometers' }) * 1000;
                var bbox = turf.bbox(routePoints);
                if (lengthInMeters >= this.defaultOptions.minFitBoundsDistance) {
...
<<<<<<< HEAD
        ...
        var source = this.map.getSource('route-point');
        var currentRoutePartId = (_d = (_c = (_b = (_a = this.routingSource.levelPaths) === null || _a === void 0 ? void 0 : _a[this.state.floor.level]) === null || _b === void 0 ? void 0 : _b.paths) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.id;
        if (currentRoutePartId) {
            var point = turf.point(((_e = this.arc[currentRoutePartId]) === null || _e === void 0 ? void 0 : _e[this.counter])
                ? (_f = this.arc[currentRoutePartId]) === null || _f === void 0 ? void 0 : _f[this.counter]
                : (_g = this.arc[currentRoutePartId]) === null || _g === void 0 ? void 0 : _g[this.counter - 1], __assign(__assign({}, this.routingSource.route[currentRoutePartId].properties), { routePartId: currentRoutePartId }));
            var start = (_h = this.arc[currentRoutePartId]) === null || _h === void 0 ? void 0 : _h[this.counter >= this.steps ? this.counter - 1 : this.counter];
            var end = (_j = this.arc[currentRoutePartId]) === null || _j === void 0 ? void 0 : _j[this.counter >= this.steps ? this.counter : this.counter + 1];
=======
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k;
        var source = this.map.getSource('route-point');
        var currentRoutePartId = this.routingSource.route["path-part-" + this.currentStep] &&
            ((_a = this.routingSource.route["path-part-" + this.currentStep].properties) === null || _a === void 0 ? void 0 : _a.level) === this.state.floor.level
            ? this.routingSource.route["path-part-" + this.currentStep].id
            : (_e = (_d = (_c = (_b = this.routingSource.levelPaths) === null || _b === void 0 ? void 0 : _b[this.state.floor.level]) === null || _c === void 0 ? void 0 : _c.paths) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.id;
        if (currentRoutePartId) {
            var point = turf.point(((_f = this.arc[currentRoutePartId]) === null || _f === void 0 ? void 0 : _f[this.counter])
                ? (_g = this.arc[currentRoutePartId]) === null || _g === void 0 ? void 0 : _g[this.counter]
                : (_h = this.arc[currentRoutePartId]) === null || _h === void 0 ? void 0 : _h[this.counter - 1], __assign(__assign({}, this.routingSource.route[currentRoutePartId].properties), { routePartId: currentRoutePartId }));
            var start = (_j = this.arc[currentRoutePartId]) === null || _j === void 0 ? void 0 : _j[this.counter >= this.steps ? this.counter - 1 : this.counter];
            var end = (_k = this.arc[currentRoutePartId]) === null || _k === void 0 ? void 0 : _k[this.counter >= this.steps ? this.counter : this.counter + 1];
>>>>>>> feature/multiple-steps-per-floor
            // Calculate the bearing to ensure the icon is rotated to match the route arc
            // The bearing is calculated between the current point and the next point, except
            // at the end of the arc, which uses the previous point and the current point
            var currentBearing = this.map.getBearing();
            var bearing = start && end ? turf.bearing(turf.point(start), turf.point(end)) : currentBearing;
            var newBearing = currentBearing;
    ...
    Map.prototype.restartAnimation = function () {
        // Reset the counter
        this.counter = 0;
        // cancel animation
        // this.cancelAnimation();
