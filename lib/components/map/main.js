    ...
    Map.prototype.onShopClick = function (e) {
        if (e.features && e.features[0] && e.features[0].properties) {
            ...
            if (this.defaultOptions.initPolygons) {
                ...
                var poi = this.state.allFeatures.features.find(function (i) { var _a; return i.properties.id === ((_a = e.features[0].properties._dynamic) === null || _a === void 0 ? void 0 : _a.id); });
                if (polygonPoi) {
    ...
    Map.prototype.setActivePolygons = function (amenityId) {
        ...
        if (this.defaultOptions.initPolygons) {
            ...
            var amenityFeatures = amenityId
                ? this.state.allFeatures.features.filter(function (f) {
                    var _a;
                    return f.properties.amenity === amenityId &&
                        ((_a = f.properties._dynamic) === null || _a === void 0 ? void 0 : _a.polygon_id) &&
                        f.geometry.type === 'Point';
                })
                : [];
            if (activeFeatures.length > 0) {
                var _loop_4 = function (f) {
                    var polygon = this_4.state.allFeatures.features.find(function (i) {
                        var _a, _b;
                        return i.properties.id === ((_a = f.properties._dynamic) === null || _a === void 0 ? void 0 : _a.polygon_id) &&
                            ((_b = i.properties._dynamic) === null || _b === void 0 ? void 0 : _b.type) === 'shop-custom';
                    });
                    if (polygon) {
