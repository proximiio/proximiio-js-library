...
var Map = /** @class */ (function () {
    ...
    Map.prototype.getClosestFeature = function (amenityId, fromFeature) {
        var sameLevelfeatures = this.state.allFeatures.features.filter(function (i) { return i.properties.amenity === amenityId && i.geometry.type === 'Point' && i.properties.level === fromFeature.properties.level; });
