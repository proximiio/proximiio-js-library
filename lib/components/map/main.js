...
var Map = /** @class */ (function () {
        ...
        var levelChangers = this.state.textNavigation.steps
            ...
            return new feature_1.default({
                ...
                properties: {
                    ...
                    popupImage: 'popup',
                    description: "".concat(i18n_1.translations[_this.defaultOptions.language][levelChangerType], " \n ").concat(i18n_1.translations[_this.defaultOptions.language][direction], " ").concat(i18n_1.translations[_this.defaultOptions.language]['TO_FLOOR'], " ").concat(destinationFloor.name ? destinationFloor.name : levelChanger.destinationLevel),
    ...
    Map.prototype.featureDialog = function (e) {
        var _this = this;
        var _a;
        var features = this.map.queryRenderedFeatures(e.point, { layers: ['proximiio-pois-icons', 'proximiio-pois-labels'] });
    ...
    Map.prototype.onFloorSelect = function (floor) {
        ...
        if (map) {
            ...
            if (route) {
                var routePoints = (0, helpers_1.lineString)(this.routingSource.levelPoints[floor.level].map(function (i) { return i.geometry.coordinates; }));
    ...
    Map.prototype.centerOnRoute = function (route) {
        if (route && route.properties) {
            ...
            if (this.map) {
                var routePoints = (0, helpers_1.lineString)(this.routingSource.levelPoints[this.state.floor.level].map(function (i) { return i.geometry.coordinates; }));
                var lengthInMeters = turf.length(routePoints, { units: 'kilometers' }) * 1000;
                var bbox = turf.bbox(routePoints);
                if (lengthInMeters >= this.defaultOptions.minFitBoundsDistance) {
                    // @ts-ignore;
