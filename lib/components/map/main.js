...
var Map = /** @class */ (function () {
    function Map(options) {
        ...
        this.onAmenityFilterListener = new rxjs_1.Subject();
        this.defaultOptions = {
    ...
    Map.prototype.initKiosk = function () {
        if (this.map) {
            ...
            if (this.defaultOptions.kioskSettings) {
                this.startPoint = turf.point(this.defaultOptions.kioskSettings.coordinates, { level: this.defaultOptions.kioskSettings.level });
        ...
        layers.forEach(function (layer) {
            if (_this.map.getLayer(layer)) {
                setTimeout(function () {
                    ...
                    if (amenityFilter !== -1) {
                        filters[amenityFilter] = ['match', ['get', 'amenity'], _this.filteredAmenities ? _this.filteredAmenities : ['undefined'], true, false];
                    }
                    else {
                        filters.push(['match', ['get', 'amenity'], _this.filteredAmenities ? _this.filteredAmenities : ['undefined'], true, false]);
                    }
    ...
    Map.prototype.onPlaceSelect = function (place, zoomIntoPlace) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Map.prototype.onFloorSelect = function (floor) {
        ...
        if (map) {
            ...
            } /* TODO kiosk point will show up after floor change and filtering */
        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        place = _a.sent();
                        return [4 /*yield*/, this.onPlaceSelect(place, true)];
                    case 2:
                        _a.sent();
    ...
    Map.prototype.findRouteByIds = function (idTo, idFrom, accessibleRoute) {
        var fromFeature = this.defaultOptions.isKiosk ? this.startPoint : this.state.allFeatures.features.find(function (f) { return f.id === idFrom || f.properties.id === idFrom; });
    ...
    Map.prototype.findRouteByTitle = function (titleTo, titleFrom, accessibleRoute) {
        var fromFeature = this.defaultOptions.isKiosk ? this.startPoint : this.state.allFeatures.features.find(function (f) { return f.properties.title === titleFrom; });
    ...
    Map.prototype.findRouteByCoords = function (latTo, lngTo, levelTo, latFrom, lngFrom, levelFrom, accessibleRoute) {
        var fromFeature = this.defaultOptions.isKiosk ? this.startPoint : turf.feature({ type: 'Point', coordinates: [lngFrom, latFrom] }, { level: levelFrom });
    ...
    Map.prototype.getAmenityFilterListener = function () {
        return this.onAmenityFilterListener.asObservable();
    };
    return Map;
}());
exports.Map = Map;
