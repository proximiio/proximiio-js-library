...
import { chevron, pulsingDot, person as personIcon, floorchangeUpImage, floorchangeDownImage, popupImage, routeStartSvg, routeFinishSvg, } from './icons';
...
export class Map {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (places && features && floors && style && kiosks) {
                ...
                this.state = Object.assign(Object.assign({}, this.state), { initializing: false, place, places: places.data, floor, floors: floors.data, kiosks: kiosks.data, style,
                    ...
                    amenities,
                    features,
                    optimizedFeatures, allFeatures: new FeatureCollection(features), levelChangers: new FeatureCollection({ features: levelChangers }), latitude: centerVar[1], longitude: centerVar[0], zoom: this.defaultOptions.zoomLevel ? this.defaultOptions.zoomLevel : (_c = this.defaultOptions.mapboxOptions) === null || _c === void 0 ? void 0 : _c.zoom, noPlaces: places.data.length === 0 });
        ...
        if (this.routingSource &&
            ...
            if (this.defaultOptions.routeAnimation.type === 'point' || this.defaultOptions.routeAnimation.type === 'puck') {
                ...
                const animate = (currentTime) => {
                    ...
                    const lineAlong = lineSplit(this.routingSource.navigationType === 'city' ? routeUntilNextStep : route, currentPoint).features[0];
    ...
    findCityRoute({ start, destination, autoStart = true, }) {
        const startFeature = feature({ type: 'Point', coordinates: [start.lng, start.lat] }, { level: 0 });
    ...
    setStop(stop) {
        ...
        if (newStopRoute) {
            ...
            if (this.routingSource.lines) {
                this.currentStop = newStop;
                this.onStopSetListener.next(this.currentStop);
                this.setNavStep((_g = (_f = (_c = this.routingSource) === null || _c === void 0 ? void 0 : _c.lines[((_e = (_d = this.routingSource) === null || _d === void 0 ? void 0 : _d.lines) === null || _e === void 0 ? void 0 : _e.length) - 1]) === null || _f === void 0 ? void 0 : _f.properties) === null || _g === void 0 ? void 0 : _g.step);
