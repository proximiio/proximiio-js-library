...
export const getAdsBundle = ({ bundleUrl, }) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const res = yield fetch(`${bundleUrl}/ads.json`);
        const data = yield res.json();
        return {
            data: data.map((item) => new AdModel(item)),
            total: +data.length,
        };
    }
    catch (e) {
