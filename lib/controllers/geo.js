...
import { booleanPointInPolygon, pointOnFeature, lineString, length, pointToLineDistance, centroid, lineOffset, transformScale, lineIntersect, } from '@turf/turf';
export const getFeatures = ({ initPolygons, autoLabelLines, hiddenAmenities, useTimerangeData, filter, featuresMaxBounds, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (initPolygons) {
        ...
        const shopPolygons = res.data.features.filter((f) => f.properties.type === 'shop' && f.geometry.type === 'MultiPolygon');
        ...
        res.data.features = res.data.features.map((feature, key) => {
            ...
            if (feature.properties.type === 'poi') {
                ...
                if (!connectedPolygon && feature.properties.metadata && feature.properties.metadata.polygon_id) {
                    connectedPolygon = res.data.features.find((f) => { var _a, _b; return ((_a = f.properties.id) === null || _a === void 0 ? void 0 : _a.replace(/\{|\}/g, '')) === ((_b = feature.properties.metadata.polygon_id) === null || _b === void 0 ? void 0 : _b.replace(/\{|\}/g, '')); });
                }
                if (connectedPolygon) {
                    ...
                    if (connectedLabelLine) {
                        ...
                        connectedLabelLine.properties._dynamic = connectedLabelLine.properties._dynamic
                            ...
                            : {};
                        connectedLabelLine.properties._dynamic.id = (_c = connectedLabelLine.properties.id) === null || _c === void 0 ? void 0 : _c.replace(/\{|\}/g, '');
...
export const getAmenities = (amenityIdProperty) => __awaiter(void 0, void 0, void 0, function* () {
