...
import { axios, getNestedObjectValue, isLevelChanger, shortenCoordinates, validateLabelLine, } from '../common';
...
export const getFeatures = ({ initPolygons, polygonLayers, autoLabelLines, hiddenAmenities, useTimerangeData, filter, featuresMaxBounds, localSources, apiPaginate, polygonBufferDistance, polygonTypesToScale, }) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    let url = '/v7/geo/features';
    ...
    if (polygonBufferDistance !== 0 && (polygonTypesToScale === null || polygonTypesToScale === void 0 ? void 0 : polygonTypesToScale.length) > 0) {
        res.data.features = res.data.features.map((feature) => {
            try {
                if ((polygonTypesToScale === null || polygonTypesToScale === void 0 ? void 0 : polygonTypesToScale.includes(feature.properties.type)) && feature.geometry.coordinates.length > 0) {
                        ...
                        if (!connectedLabelLine) {
                            ...
                            if (labelLine &&
                                ...
                                if (longestBorderIndex !== -1) {
                                    ...
                                    labelBorder = transformScale(lineOffset(longestBorder, polygonBufferDistance !== 0 ? -distanceToCenter : distanceToCenter), 10);
...
export const getFeaturesBundle = ({ initPolygons, polygonLayers, autoLabelLines, hiddenAmenities, useTimerangeData, filter, bundleUrl, bundlePaginate, polygonBufferDistance, polygonTypesToScale, }) => __awaiter(void 0, void 0, void 0, function* () {
    let data = {
        features: [],
        count: 0,
        type: 'FeatureCollection',
    ...
    originalFeatures = Object.assign({}, data);
    if (polygonBufferDistance !== 0 && (polygonTypesToScale === null || polygonTypesToScale === void 0 ? void 0 : polygonTypesToScale.length) > 0) {
