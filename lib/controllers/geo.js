...
exports.getPois = exports.getAmenities = exports.getFeatures = void 0;
                ...
                if (initPolygons) {
                    ...
                    res.data.features = res.data.features.map(function (feature, key) {
                        ...
                        if (feature.properties.type === 'poi' && feature.properties.metadata && feature.properties.metadata.polygon_id) {
                            ...
                            var polygon = res.data.features.find(function (f) { var _a, _b; return ((_a = f.properties.id) === null || _a === void 0 ? void 0 : _a.replace(/\{|\}/g, '')) === ((_b = feature.properties.metadata.polygon_id) === null || _b === void 0 ? void 0 : _b.replace(/\{|\}/g, '')); });
                            if (polygon) {
                                var polygonFeature = JSON.parse(JSON.stringify(polygon));
                                polygonFeature.properties.id = (_a = polygonFeature.properties.id) === null || _a === void 0 ? void 0 : _a.replace(/\{|\}/g, '');
