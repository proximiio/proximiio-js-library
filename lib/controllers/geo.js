...
var getFeatures = function (_a) {
    var initPolygons = _a.initPolygons, autoLabelLines = _a.autoLabelLines, hiddenAmenities = _a.hiddenAmenities, useTimerangeData = _a.useTimerangeData, filter = _a.filter, featuresMaxBounds = _a.featuresMaxBounds;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (featuresMaxBounds) {
                        url += "/".concat(featuresMaxBounds[0][0], ",").concat(featuresMaxBounds[0][1], ",").concat(featuresMaxBounds[1][0], ",").concat(featuresMaxBounds[1][1]);
                    }
                ...
                case 1:
                    ...
                    if (initPolygons) {
                        ...
                        if (filter && filter.key && filter.value) {
                            res.data.features = res.data.features
                                .map(function (feature) {
                                if ((0, common_1.getNestedObjectValue)(feature, filter.key)) {
                                    // if feature filter property exists
                                    if ((0, common_1.getNestedObjectValue)(feature, filter.key) === filter.value) {
                            ...
                            if (feature.properties.type === 'poi') {
                                ...
                                shopPolygons_1.forEach(function (polygon) {
                                    ...
                                    if (((_a = feature.properties) === null || _a === void 0 ? void 0 : _a.level) === ((_b = polygon.properties) === null || _b === void 0 ? void 0 : _b.level)) {
                                        if ((0, turf_1.booleanPointInPolygon)(feature, polygon)) {
                                ...
                                if (connectedPolygon_1) {
                                    ...
                                    labelLineFeatures_1.forEach(function (line) {
                                        ...
                                        if (((_a = connectedPolygon_1.properties) === null || _a === void 0 ? void 0 : _a.level) === ((_b = line.properties) === null || _b === void 0 ? void 0 : _b.level)) {
                                            if ((0, turf_1.booleanPointInPolygon)((0, turf_1.pointOnFeature)(line), connectedPolygon_1)) {
                                    ...
                                    if (connectedLabelLine_1) {
                                        ...
                                        connectedLabelLine_1.properties._dynamic.length = Math.ceil((0, turf_1.length)(connectedLabelLine_1) * 1000);
                                    ...
                                    if (!connectedLabelLine_1) {
                                        ...
                                        if (labelLine && labelLine !== undefined && labelLine.length > 0) {
                                            ...
                                            if (parsedLabelLine[0] instanceof Array && parsedLabelLine[1] instanceof Array) {
                                                ...
                                                labelLineFeature.properties._dynamic.length = Math.ceil((0, turf_1.length)(labelLineFeature) * 1000);
                                            ...
                                            for (var i = 0; i < connectedPolygon_1.geometry.coordinates[0][0].length; i++) {
                                                ...
                                                if (nextCoords) {
                                                    var border = (0, turf_1.lineString)([currentCoords, nextCoords], __assign({}, feature.properties));
                                                    // measure border length
                                                    var borderLength = (0, turf_1.length)(border);
                                                    border.properties._dynamic = __assign(__assign({}, border.properties._dynamic), { length: Math.ceil(borderLength * 1000) });
                                            ...
                                            var distanceToCenter = (0, turf_1.pointToLineDistance)((0, turf_1.centroid)(connectedPolygon_1), longestBorder);
                                            // offset border to polygon center and make it longer to get intersections with the polygon
                                            labelBorder = (0, turf_1.lineOffset)(longestBorder, distanceToCenter);
                                            labelBorder = (0, turf_1.transformScale)(labelBorder, 10);
                                            var intersection = (0, turf_1.lineIntersect)(connectedPolygon_1, labelBorder);
                                            // if there are more than 1 intersections, get the line betweeen them
                                            if (intersection.features.length > 1) {
                                                var intersectedLine = (0, turf_1.lineString)([
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                pois = __spreadArray(__spreadArray([], res.data.features, true), customPois.features, true).filter(function (feature) { return feature.properties.usecase === 'poi' || feature.properties.type === 'poi'; })
