                        ...
                        if (feature.properties.type === 'poi') {
                            ...
                            if (connectedPolygon_1) {
                                ...
                                var labelLine = connectedPolygon_1.properties['label-line']
                                    ? JSON.parse(connectedPolygon_1.properties['label-line'])
                                    : connectedPolygon_1.properties.metadata['label-line']
                                        ? JSON.parse(connectedPolygon_1.properties.metadata['label-line'])
