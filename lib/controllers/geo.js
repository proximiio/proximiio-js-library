                            ...
                            if (connectedPolygon_1) {
                                ...
                                if (!connectedLabelLine_1) {
                                    ...
                                    if (labelLine && labelLine !== undefined && labelLine.length > 0) {
                                        ...
                                        labelLine_1 = turf_1.lineOffset(longestBorder, distanceToCenter);
                                        labelLine_1 = turf_1.transformScale(labelLine_1, 10);
                                        var intersection = turf_1.lineIntersect(connectedPolygon_1, labelLine_1);
                                        ...
                                        if (intersection.features.length > 1) {
                                            ...
                                            labelLine_1.geometry = intersectedLine.geometry;
                                        }
                                        labelLine_1.properties.id = JSON.stringify(key + 9999);
                                        labelLine_1.id = JSON.stringify(key + 9999);
                                        labelLine_1.properties.type = 'shop-label';
                                        labelLine_1.properties._dynamic.type = 'shop-label';
                                        connectedPolygon_1.properties._dynamic.label_id = labelLine_1.properties.id;
                                        featuresToAdd_1.push(labelLine_1);
                                    }
                                }
                            }
                        }
