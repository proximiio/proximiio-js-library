            ...
            switch (_b.label) {
                case 0:
                    ...
                    promises = [
                        ...
                        geo_1.getFeatures({ initPolygons: initPolygons, autoLabelLines: autoLabelLines, hiddenAmenities: hiddenAmenities, useTimerangeData: useTimerangeData, filter: filter, featuresMaxBounds: featuresMaxBounds }).then(function (features) { return (result.features = features); }),
