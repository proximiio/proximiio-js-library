...
export declare const getFeatures: ({ initPolygons, polygonLayers, autoLabelLines, hiddenAmenities, useTimerangeData, filter, featuresMaxBounds, localSources, apiPaginate, polygonBufferDistance, polygonTypesToScale, }: {
    ...
    modifiedFeatures: FeatureCollection;
    originalFeatures: {
        features: any;
        type: "FeatureCollection";
    };
}>;
export declare const getFeaturesBundle: ({ initPolygons, polygonLayers, autoLabelLines, hiddenAmenities, useTimerangeData, filter, bundleUrl, bundlePaginate, polygonBufferDistance, polygonTypesToScale, }: {
    initPolygons?: boolean;
    polygonLayers: PolygonLayer[];
    autoLabelLines?: boolean;
    hiddenAmenities?: string[];
