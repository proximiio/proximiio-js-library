...
var Wayfinding = exports.Wayfinding = /*#__PURE__*/function () {
  // meters / second
  ...
  _createClass(Wayfinding, [{
    ...
    value: function rebuildData() {
      ...
      this.corridors.forEach(function (corridor, _) {
        ...
        for (var _i = 0; _i < coordinateList.length - 1; _i++) {
          ...
          var isAvailableNow = _this3._checkTimeBased(corridor) && _this3._checkAvailablePath(corridor);
          ...
          var isNarrowPath = corridor.properties.narrowPath === true;
          ...
          var isHill = corridor.properties.ramp === true;
      ...
      while (i < corridorLinePointPairs.length) {
        ...
        var segmentLineString = corridorLineFeatures[i];
      ...
      var _loop2 = function _loop2() {
        ...
        if (segmentIntersectionList) {
          segmentIntersectionList.forEach(function (intersection) {
            ...
            var isAvailableNow = segmentFeature.properties.isAvailableNow;
      ...
      var segmentToWallIntersectionPointList = [];

      // Split corridor lines on interesections wilth walls
      i = 0;
      var _loop3 = function _loop3() {
        var _this3$floorData$get, _this3$floorData$get2;
        var segment = corridorLinePointPairs[i];
        var segmentFeature = corridorLineFeatures[i];
        var segmentIntersections = [];
        var walls = (_this3$floorData$get = _this3.floorData.get(segment[0].properties.level)) === null || _this3$floorData$get === void 0 ? void 0 : _this3$floorData$get.walls;
        var wallFeatures = (_this3$floorData$get2 = _this3.floorData.get(segment[0].properties.level)) === null || _this3$floorData$get2 === void 0 ? void 0 : _this3$floorData$get2.wallFeatures;
        if ((wallFeatures === null || wallFeatures === void 0 ? void 0 : wallFeatures.length) > 0) {
      ...
      this.levelChangerList.forEach(function (levelChanger) {
        ...
        if (levelChanger.properties.group !== undefined) {
          ...
          var group = levelChangerGroupMap.get(groupId);
          // Add lc to group map
    ...
    value: function _generateNeighbourhoodMap() {
      ...
      this.floorData.forEach(function (levelFloorData, level) {
        ...
        levelPoints.forEach(function (point) {
          ...
          var unwrappedPoint = _this5._unwrapLevelChangerPoint(point, level);
      ...
      this.corridorLinePoints.forEach(function (point) {
        ...
        var neighbours;
        var levelNeighboursMap = neighboursMap[level];
        ...
        if (point.properties.bordersArea) {
          ...
          neighbours = _this5._findNeighbours(point, point, null, potentialPoints);
    ...
    value: function _generateWallOffsets() {
      ...
      pointList.forEach(function (point) {
        ...
        var walls = (_this6$floorData$get = _this6.floorData.get(point.properties.level)) === null || _this6$floorData$get === void 0 ? void 0 : _this6$floorData$get.walls.filter(function (wall) {
        ...
        _this6.floorData.get(point.properties.level).walls.forEach(function (wall, index) {
          ...
          var lineWall = _this6.floorData.get(point.properties.level).wallFeatures[index];
    ...
    value: function reconstructPath(current) {
      ...
      for (var i = 0; i < path.length - 1; i++) {
        ...
        var distanceAtoB = this._distance(pointA, pointB);
        // 70cm
        if (distanceAtoB < 0.7) {
    ...
    value: function _calculateWallOffsetPointList(currentPoint, previousPoint) {
      ...
      var offsetPointList = [];
      var currentOffsetPoint = currentPoint;
      ...
      var _loop4 = function _loop4() {
        ...
        _this8.wallOffsetLineList.forEach(function (wallOffsetLine, index) {
          ...
          if (intersection.features.length > 0) {
            var offsetPoint = _this8.wallOffsets[index];
    ...
    value: function calculatePath(startPoint, endPoint) {
      ...
      var _loop5 = function _loop5() {
          var current = _this12._getMinFScore(openSet, closedSet);
    ...
    value: function _findNeighbours(point, startPoint, endPoint, proposedPointList) {
      ...
      for (var index in proposedPointList) {
        var proposedPoint = proposedPointList[index];
    ...
    value: function _getFixPointInArea(point) {
      ...
      var floorData = this.floorData.get(point.properties.level);

      // If point is located without accessible area, do nothing
      var pointFound = undefined;
      if ((floorData === null || floorData === void 0 ? void 0 : floorData.areas.length) > 0) {
      ...
      if ((floorData === null || floorData === void 0 ? void 0 : floorData.wallFeatures.length) > 0) {
      ...
      if (bestWall === null && bestCorridorIndex === null) {
        ...
        if (bestCorridorIndex !== undefined && bestCorridorDistance < bestWallDistance) {
          ...
          var isAvailableNow = this.corridorLineFeatures[bestCorridorIndex].properties.isAvailableNow;
    ...
    value: function _checkShortPath(start, end) {
      ...
      if (startCorridor.properties.corridorIndex === endCorridor.properties.corridorIndex) {
        ...
        var isAvailableNow = corridor.properties.isAvailableNow;
        if (!isAvailableNow) {
          return false;
        }
        var isBidirectional = corridor.properties.bidirectional === undefined || corridor.properties.bidirectional === true;
    ...
    key: "_checkTimeBased",
    value: function _checkTimeBased(feature) {
      ...
      if (feature.properties.workingHours !== undefined) {
        ...
        var openings = feature.properties.workingHours[currentDay];

        // Current hour in UTC
        var currentHour = parseInt(now.getHours());
        var currentMinute = parseInt(now.getMinutes());
        ...
        // Retrieve opening
        var opening = openings[0].split(':');
        var openingHour = parseInt(opening[0]);
        var openingMinute = parseInt(opening[1]);
        var open = openingHour * 60 + openingMinute;

        // Retrieve closing
        var closing = openings[1].split(':');
        var closingHour = parseInt(closing[0]);
        var closingMinute = parseInt(closing[1]);
        var close = closingHour * 60 + closingMinute;
    ...
    key: "_checkAvailablePath",
    value: function _checkAvailablePath(feature) {
      var useForPath = true;
