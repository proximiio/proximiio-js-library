import { Feature, Geometry, Position, Polygon, MultiPolygon } from 'geojson';
 ...
 */
export function isPolygonal(feature: Feature): boolean {
 ...
 */
export function rewind(feat: Feature, outer: boolean): void {
 ...
 */
function correctRings(coords: Position[][], outer: boolean): void {
 ...
 */
function wind(coords: Position[], outer: boolean): void {
